...
import { getAllFanFavourites, getAllPopular, getAllTopTrending, getTop50 } from '../../lib/Calls';
import AnimeBanner from '../../components/AnimeBanner';
import AnimeCardSlider from '../../components/AnimeCardSlider';
export default async function TopAllPopular() {
    const data= await getAllPopular();
    // console.log(data)
  return (
    <>
     <div className='w-[100%]'>
